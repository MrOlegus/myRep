...
namespace Lab1
{
    ...
    {
        public Circle(Point pos, int width) : base(pos, width, width)
        { // вызов конструктора базового класса 
        }

        public Circle(Point pos, int width, Color fill, Color outline, int depth)
            : base(pos, width, width, fill, outline, depth)
        { // вызов конструктора базового класса 
        }

        public Circle(Point pos0, Point pos1)
            : base(pos0, new Point(pos1.X, pos0.Y + (pos1.X - pos0.X)))
        { // вызов конструктора базового класса 
        }

        public Circle(Point pos0, Point pos1, Color fill, Color outline, int depth)
